...
import { Mail, FileText, Eye, MessageSquare, ChevronDown } from 'lucide-react';
...
const Dashboard = () => {
    ...
    const fetchData = async () => {
        try {
            const params = user?.role === 'admin' && selectedHotel ? { hotelId: selectedHotel } : {};
    ...
    const handleEmailSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const emailList = emails
                ...
                .filter(Boolean);
            const payload = user?.role === 'admin' ? { emails: emailList, hotelId: selectedHotel } : { emails: emailList };
                                            ...
                                            {reviews.map((review) => (
                                                <React.Fragment key={review._id}>
                                                    ...
                                                    >
                                                        ...
                                                        <TableCell>{new Date(review.stayDate).toLocaleDateString()}</TableCell>
                                                        <TableCell>
                                                            <Rating
                                                                value={review.rating}
                                                                readOnly
