...
import { Box, Card, CardContent, Typography, Grid, CircularProgress, Rating, LinearProgress } from '@mui/material';
                                ...
                                return (
                                    <Box key={rating} sx={{ mb: 2 }}>
                                        <Box sx={{ display: 'flex', alignItems: 'center', mb: 1 }}>
                                            ...
                                            <Typography color="text.secondary">({count} reviews)</Typography>
                                        </Box>
                                        <LinearProgress
                                            variant="determinate"
                                            value={percentage}
